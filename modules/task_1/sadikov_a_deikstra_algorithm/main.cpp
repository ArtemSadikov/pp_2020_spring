...
TEST(Deikstra_algorithm, Test_On_Six_Points_Graph) {
...
TEST(Deikstra_algorithm, Test_On_Three_Points) {
...
TEST(Deikstra_algorithm, Test_On_Wrong_Arguments) {
    std::vector<int> g = {0, 7, 9, 0, 0, 14,
                          7, 0, 10, 15, 0, 0,
                          9, 10, 0, 11, 0, 2,
                          0, 15, 11, 0, 6, 0,
...
TEST(Deikstra_algorithm, Test_Return_0_If_Equal_Start_And_End) {
    std::vector<int> g = {0, 2, 3,
                          2, 0, 1,
                          3, 1, 0};
...
TEST(Deikstra_algorithm, Test_On_Six_Points_Graph_Another_Way) {
    std::vector<int> g = {0, 7, 9, 0, 0, 14,
                          7, 0, 10, 15, 0, 0,
                          9, 10, 0, 11, 0, 2,
                          0, 15, 11, 0, 6, 0,
